...
test(
  ...
  async () => {
    ...
    if ("error" in meta1)
      throw new Error("meta1 has error: " + (meta1 as any).error);
    if ("error" in meta2)
      throw new Error("meta2 has error: " + (meta2 as any).error);
    if ("error" in meta3)
      throw new Error("meta3 has error: " + (meta3 as any).error);
